...
window.SC = window.SC || {}; window.SC.URI = function(uri, options) {
...
(function() {
  var AbstractDialog, ConnectDialog, EchoDialog, PickerDialog, _ref, _ref1, _ref2,
    ...
    Dialog: {
      ...
      AbstractDialog: AbstractDialog = (function() {
        ...
        AbstractDialog.prototype.generateId = function() {
          return [this.ID_PREFIX, Math.ceil(Math.random() * 1000000).toString(16)].join("_");
        };
